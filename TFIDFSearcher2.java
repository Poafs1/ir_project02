...
////		List<String> terms;
////		List<SearchResult> searchResult = new LinkedList<>();
////
...
//		{
//			Set<String> union = new HashSet<String>(tokens);
//			Set<String> intersect = new HashSet<String>(tokens);
//			
//			term = doc.getTokens();
//			
//			union.addAll(term);
...
//			searchResult.add(new SearchResult(doc,score));
//		}
//		
//		Collections.sort(searchResult);
//		return searchResult.subList(0, k);
//		/***********************************************/
//	}
//}
